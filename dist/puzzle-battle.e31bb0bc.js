...
},{"./api":"node_modules/chessground/api.js","./config":"node_modules/chessground/config.js","./state":"node_modules/chessground/state.js","./wrap":"node_modules/chessground/wrap.js","./events":"node_modules/chessground/events.js","./render":"node_modules/chessground/render.js","./svg":"node_modules/chessground/svg.js","./util":"node_modules/chessground/util.js"}],"puzzles.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getRandomPuzzle = void 0;
var puzzles = [{
  PuzzleId: "0000D",
...
function afterMove(orig, dest, capturedPiece) {
  ...
  window.ground.set({
    movable: {
      color: oppositeColor(window.ground.state.movable.color)
    }
  });
}
...
function getColorFromFen(fen) {
  var colorChar = fen.split(" ")[1];
  return colorChar === "w" ? "white" : "black";
}

var puzzle = puzzles_1.getRandomPuzzle();
...
},{"./protocol":"protocol.ts","chessground":"node_modules/chessground/chessground.js","./puzzles":"puzzles.ts"}],"protocol.ts":[function(require,module,exports) {
"use strict";
